...
*** Sorting a list of lists according to length of sublists 
    ...
    #+BEGIN_SRC emacs-lisp
      (let ((l '((a b c) (d e) (f g h) (d e) (i j k l) (m n) (o))))
        (sort l (lambda (elt1 elt2) (< (length elt1) (length elt2)))))
    #+END_SRC
    ...
    #+BEGIN_SRC emacs-lisp
      (let* ((l '((a b c) (d e) (f g h) (d e) (i j k l) (m n) (o)))
             (lens (mapcar #'length l)))
        (sort l (lambda (elt1 elt2)
                  (< (count (length elt1) lens)
                     (count (length elt2) lens)))))
    #+END_SRC
...
*** TODO Determine whether a given integer number is prime
